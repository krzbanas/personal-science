...
math = false
+++
Numerical integration in R by fitting a piece-wise linear function. Example adapted from quoted sources. First piece-wise linear function is fitted by 'approxfun', then integration is done over the 
